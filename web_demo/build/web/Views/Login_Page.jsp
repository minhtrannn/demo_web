...
<html>
    <head>
        ...
        <link href="../CSS/CSS_Login_Page/body-login-page.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="header" >
            ...
            <div class="login-part-1">
                <div class="login-part-1-contain">
                    ...
                    <form class="form-login">
                        ...
                        <button class="login-now" type="submit" aria-label="Login">
                            <div>
                                <span>LOGIN</span>
                            </div>
    ...
    <script src="../Javascript/js_login_page/loginPage.js" type="text/javascript"></script>
</html>
